...
* Install a 16Gb or faster FC card. The number of cards and ports on each card will be determine by the failure cases you are solving for as well as the bandwidth required in the event of those failures.
